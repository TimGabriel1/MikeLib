...
public class UpdateBook extends javax.swing.JFrame {
    ...
    public UpdateBook(Book book) {
        ...
        //Display book details on component
        bookName.setText(book.getBook_name());
        bookPrice.setText(book.getPrice()+"");
        for(int i=0; i<bookUnit.getItemCount(); i++){
           if(book.getUnit().equals(bookUnit.getItemAt(i))){
               bookUnit.setSelectedIndex(i);
           }
        }
    }
    ...
    private void updateFoodBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateFoodBtnActionPerformed
        ...
        String unit = bookUnit.getSelectedItem().toString();
        ...
        if(name.isBlank() || price.isNaN() || unit.isBlank()){
            ...
            if(bookController.updateBook(book)){
                JOptionPane.showMessageDialog(rootPane, book.getBook_name()+" updated successfully");
